...
!macro customInit
  ...
  nsExec::ExecToLog 'cmd.exe /c "taskkill /F /IM cloudflared-run.exe /T 2>nul"'
  nsExec::ExecToLog 'cmd.exe /c "taskkill /F /IM cloudflared-run2.exe /T 2>nul"'
  nsExec::ExecToLog 'cmd.exe /c "taskkill /F /IM cloudflared-run3.exe /T 2>nul"'
  Sleep 2500
  RMDir /r "$INSTDIR"
!macroend
