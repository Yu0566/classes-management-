      ...
      <div className="p-5 max-w-6xl mx-auto space-y-4">
          ...
          <div className="p-6">
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              {todayDow >= 1 && todayDow <= 5 && (
                <span className="text-sm text-amber-400 font-medium ml-1">{WEEKDAY_NAMES[todayDow]}</span>
              )}
            </div>
            ...
            <div className="flex items-center justify-center flex-wrap gap-8">
              ...
              {monitor && (
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-amber-600 bg-amber-50 px-2 py-0.5 rounded-full">班长</span>
                  <span className="text-base font-bold text-slate-800">{monitor.student_name}</span>
                </div>
              )}
              ...
              {todayCaptainOrVice && (
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-amber-600 bg-amber-50 px-2 py-0.5 rounded-full">{todayCaptainLabel}</span>
                  <span className="text-sm font-bold text-slate-700">{todayCaptainOrVice.student_name}</span>
                </div>
              )}
              ...
              {todayRotation.map(s => (
                <div key={s.id} className="flex flex-col items-center gap-2">
                  <div className="w-20 h-20 rounded-full bg-gradient-to-br from-slate-200 to-amber-200 p-[3px] shadow-md">
                    <div className="w-full h-full rounded-full bg-gray-50 flex items-center justify-center overflow-hidden">
                      {s.photo ? (
                  ...
                  <span className="text-xs font-medium text-slate-400 bg-slate-100 px-2 py-0.5 rounded-full">轮值</span>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-stretch">
            {/* 作业 */}
            <div className="relative bg-white rounded-2xl border border-slate-200 overflow-hidden flex flex-col h-full">
